...
export default class GoalCommentModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            commentor: "",
    ...
    goalCommentFunc = () => {
        ...
        this.props.goalCommentFunction(goalId, commentor, message);
    };

    render() {
        const { toggleModal, selectedGoal, selectedGoalId } = this.props;
        // console.log("commentModalSelectedGoal: ", selectedGoal);
        // console.log("commentModalSelectedGoalId: ", selectedGoalId);
        const { commentor, message } = this.state;

        const comments = selectedGoal.comments || [];
        return (
